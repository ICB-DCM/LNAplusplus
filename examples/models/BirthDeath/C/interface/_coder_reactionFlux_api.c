...
static const mxArray *s_emlrt_marshallOut(const real_T u[2]);
static const mxArray *t_emlrt_marshallOut(const real_T u[3]);
...
void Y0_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  real_T (*out1)[2];
  real_T (*in1)[6];
  emlrtStack st = { NULL, NULL, NULL };
  ...
  st.tls = emlrtRootTLSGlobal;
  out1 = (real_T (*)[2])mxMalloc(sizeof(real_T [2]));
  prhs[0] = emlrtProtectR2012b(prhs[0], 0, false, -1);
  ...
  /* Marshall function outputs */
  plhs[0] = s_emlrt_marshallOut(*out1);
}
...
static const mxArray *s_emlrt_marshallOut(const real_T u[2])
{
  ...
  y = NULL;
  m18 = emlrtCreateNumericArray(2, iv36, mxDOUBLE_CLASS, mxREAL);
  mxSetData((mxArray *)m18, (void *)u);
  emlrtSetDimensions((mxArray *)m18, iv37, 2);
  emlrtAssign(&y, m18);
  return y;
}

void V0_api(const mxArray *prhs[1], const mxArray *plhs[1])
{
  real_T (*out1)[3];
  real_T (*in1)[6];
  emlrtStack st = { NULL, NULL, NULL };
  ...
  st.tls = emlrtRootTLSGlobal;
  out1 = (real_T (*)[3])mxMalloc(sizeof(real_T [3]));
  prhs[0] = emlrtProtectR2012b(prhs[0], 0, false, -1);
  ...
  /* Marshall function outputs */
  plhs[0] = t_emlrt_marshallOut(*out1);
}

static const mxArray *t_emlrt_marshallOut(const real_T u[3])
{
  const mxArray *y;
  static const int32_T iv38[1] = { 0 };

  const mxArray *m19;
  static const int32_T iv39[1] = { 3 };

  y = NULL;
  m19 = emlrtCreateNumericArray(1, iv38, mxDOUBLE_CLASS, mxREAL);
  mxSetData((mxArray *)m19, (void *)u);
  emlrtSetDimensions((mxArray *)m19, iv39, 1);
  emlrtAssign(&y, m19);
  return y;
}
  ...
  const emlrtMsgIdentifier *msgId))[6]
{
  ...
  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, iv41);
