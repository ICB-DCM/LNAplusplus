 ...
 * d2AdThetadPhi.c
 *
 * Code generation for function 'd2AdThetadPhi'
 *
 */
...
void d2AdThetadPhi(const double in1[2], double t, const double in3[6], double
                   b_d2AdThetadPhi[48])
{
  (void)in1;
  (void)t;
  ...
  memset(&b_d2AdThetadPhi[0], 0, 48U * sizeof(double));
}

/* End of code generation (d2AdThetadPhi.c) */
