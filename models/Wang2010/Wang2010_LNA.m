...
%Usage:
%	[MRE,Var,dMREdTheta,dVardTheta,dMRE2dTheta2,dVar2dTheta2] = Wang2010_LNA(Theta, tspan, [obsVar], [merr], [Y0], [V0])
...
function varargout = Wang2010_LNA(par, tspan, varargin)
if nargout > 4
    [Y Sigma Sens_MRE Sens_Var Sens2_MRE Sens2_Var] =  Wang2010_LNA_mex(par, tspan, varargin);                   
    Y       = squeeze(Y);                                                                                  
    Sigma   = squeeze(Sigma);                                                                              
...
elseif nargout > 2                                                                                         
    [Y Sigma Sens_MRE Sens_Var] =  Wang2010_LNA_mex(par, tspan, varargin);                                       
    Y       = squeeze(Y);                                                                                  
    Sigma   = squeeze(Sigma);                                                                              
    Sens_MRE  = squeeze(Sens_MRE);                                                                         
    Sens_Var  = squeeze(Sens_Var);                                                                         
    ...
    [Y Sigma] =  Wang2010_LNA_mex(par, tspan, varargin);                                                         
    Y       = squeeze(Y);                                                                                  
    Sigma   = squeeze(Sigma);                                                                              
    varargout = {Y, Sigma};                                                                                
end                                                                                                        
