...
static void b_info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, b_emlrt_marshallOut(1343830386U), "fileTimeLo", 89);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Users/justinfeigelman/Projects/LNA++/matlab/models/BirthDeath/matlab/systemJacobian.m"),
                "context", 90);
  emlrtAddField(*info, emlrt_marshallOut("rdivide"), "name", 90);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 90);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "resolved", 90);
  emlrtAddField(*info, b_emlrt_marshallOut(1363713880U), "fileTimeLo", 90);
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]/Users/justinfeigelman/Projects/LNA++/matlab/models/BirthDeath/matlab/systemJacobian.m"),
                "context", 91);
  emlrtAddField(*info, emlrt_marshallOut("reshape"), "name", 91);
  emlrtAddField(*info, emlrt_marshallOut("double"), "dominantType", 91);
  emlrtAddField(*info, emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m"), "resolved", 91);
  emlrtAddField(*info, b_emlrt_marshallOut(1378295982U), "fileTimeLo", 91);
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxArray *xEntryPoints = mxCreateStructMatrix(1,24,4,epProperties);
  ...
  xInputs = mxCreateLogicalMatrix(1, 3);
  mxSetFieldByNumber(xEntryPoints, 23, 0, mxCreateString("systemJacobian"));
  mxSetFieldByNumber(xEntryPoints, 23, 1, mxCreateDoubleScalar(3));
