/*
 * reactionFlux_initialize.c
 *
 * Code generation for function 'reactionFlux_initialize'
 *
 */
...
#include "reactionFlux_initialize.h"

/* Function Definitions */
void reactionFlux_initialize(void)
{
  rt_InitInfAndNaN(8U);
}

/* End of code generation (reactionFlux_initialize.c) */
