...
module1 = Extension('myModuleLNA',
                    define_macros = [('MAJOR_VERSION', '1'),
                                     ('MINOR_VERSION', '0')],
                    include_dirs = INCLUDE_DIRS + ['/usr/local/include', 'myModule/C', '../include', '../src', 
								'../libraries/blitz-1.0.1/install/include', '../libraries/cvodes-2.7.0/install/include', numpyPath],
                    libraries = ['stdc++', 'sundials_cvodes', 'blitz', 'sundials_nvecserial'], #,'python3.4'],
                    library_dirs = LIB_DIRS + ['/usr/local/lib', '../libraries/blitz-1.0.1/install/lib', '../libraries/cvodes-2.7.0/install/lib/'],
