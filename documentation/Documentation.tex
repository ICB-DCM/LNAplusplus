...
\subsubsection*{Blitz++}
Blitz++ version 0.9 or greater is required. It can be obtained via the included source code in \texttt{./libraries}, or from \href{http://sourceforge.net}{http://sourceforge.net}.  It is also available via macports on mac OS, and the apt repository on Ubuntu.
