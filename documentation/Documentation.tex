...
For other versions of Blitz++ in non-default locations you need to adapt 'include\_dirs' and 'library\_dirs' in 'python/setupTemplate.py'.
...
See \texttt{BirthDeath.m} in \texttt{./models} for an example of how this is done.
