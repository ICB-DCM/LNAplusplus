...
\end{eqnarray}
with $$(\bb{E} \bb{E}^T)'_k := \frac{d (\bb{E} \bb{E}^T)}{d \theta_k} = \frac{d}{d \theta_j} \left( \sum_\ell \frac{\partial (\bb{E} \bb{E}^T)}{\partial \bs{\phi}_\ell} (\bs{\phi}_\ell)'_k +  \frac{\partial (\bb{E} \bb{E}^T)}{\partial \theta_k}\right),$$
