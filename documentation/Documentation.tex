...
See \texttt{runBirthDeath.m} in \texttt{examples/}, and the generated \texttt{models/BirthDeath/BirthDeath\_LNA.m} for an example of the generated wrapper function and its invocation.
...
# Generate the symbolic C code:
tups = generateLNAComponents(model,S,f,\
